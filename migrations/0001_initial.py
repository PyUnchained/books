    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guarantee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ts_guarantee', to='books.Upload')),
                ('recourse_measures', models.ManyToManyField(blank=True, related_name='ts_recourse', to='books.Upload')),
                ('security', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ts_security', to='books.Upload')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term_sheet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.TermSheet')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term_sheet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='books.TermSheet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.ManyToManyField(blank=True, help_text='Choose one of account type or specific account.', to='books.AccountGroup')),
                ...
                ('rule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.JournalEntryRule')),
            ],
        ),
        migrations.CreateModel(
            name='JournalEntry',
            fields=[
                ...
                ('credit_acc', models.ManyToManyField(blank=True, related_name='credit_entry', to='books.Account', verbose_name='credit')),
                ...
                ('debit_acc', models.ManyToManyField(blank=True, related_name='debit_entry', to='books.Account', verbose_name='debit')),
                ...
                ('rule', models.ForeignKey(blank=True, help_text='Please select a rule, then save and continue.', null=True, on_delete=django.db.models.deletion.CASCADE, to='books.JournalEntryRule')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('code', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=120)),
                ('rule', models.ForeignKey(blank=True, help_text='Custom user defined rule.', null=True, on_delete=django.db.models.deletion.CASCADE, to='books.JournalCreationRule')),
            ],
        ),
        migrations.AddField(
            model_name='account',
